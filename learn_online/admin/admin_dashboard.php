                ...
                <div class="subject-container">
                    <?php foreach ($courses as $course) : ?>
                        <div class="box">
                            ...
                            <div class="inline">
                                <a href="assignment/create_assignment.php?course_id=<?php echo $course['course_id']; ?>">
                                    <img id="assignment" src="../assets/img/assignment.png" alt="">
                                </a>
                                <div>Assignment</div>
                            </div>
                            <div class="inline">
                                <a href="quiz/create_quiz.php?course_id=<?php echo $course['course_id'];?>">
                                    <img id="quiz" src="../assets/img/quiz.png" alt="">
                                </a>
                                <div>Quiz</div>
                            </div>
                            <div class="inline">
                                <a href="lesson/create_lesson.php?course_id=<?php echo $course['course_id'];?>">
