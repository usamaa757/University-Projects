...
include 'course_fetching_process.php';
                ...
                <div class="subject-container">
                    <?php foreach ($courses as $course) : ?>
                        <div class="box">
                            ...
                            <div class="inline">
                                <a href="assignment/assignment_list.php?course_id=<?php echo $course['course_id']; ?>">
                                    <img id="assignment" src="../assets/img/assignment.png" alt="">
                                </a>
                                <div>Assignment</div>
                            </div>
                            <div class="inline">
                                <a href="quiz/quiz_list.php?course_id=<?php echo $course['course_id'];?>">
                                    <img id="quiz" src="../assets/img/quiz.png" alt="">
                                </a>
                                <div>Quiz</div>
                            </div>
                            <div class="inline">
                                <a href="lesson/student_lesson_list.php?course_id=<?php echo $course['course_id'];?>">
