...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2025 at 10:46 PM
...
INSERT INTO `users` (`user_id`, `name`, `email`, `password_hash`, `profile_pic`, `role`, `created_at`, `is_verified`, `verification_token`, `reset_token`, `token_expiry`) VALUES
(1, 'Administrator', 'admin@gmail.com', '$2y$10$hYFJ.rm6umRRNlya5tDPdeQVsEZjOvWd0UxI/OoBy3EgkkOO9U0YW', '6806108d82a38.png', 'admin', '2025-04-21 09:32:03', 1, NULL, NULL, NULL);
