...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment'])) {
    ...
    if (!$user_id) {
        ...
        notify_users($topic_id, $comment, $parent_comment_id !== "NULL" ? $parent_comment_id : null);
...
<div class="container mt-5">
    ...
    if (!empty($error)): ?>
        <p class="text-success mt-2"><?= htmlspecialchars($error) ?></p>
    <?php endif; ?>
    <!-- Main Comment Form -->
    <div class="card mt-4">
        <div class="card-header bg-dark text-white">
            ...
            function render_comments($parent_id = null, $depth = 0)
            {
                ...
                if (isset($comments_by_parent[$parent_id])) {
                    foreach ($comments_by_parent[$parent_id] as $row) {
                        ...
                        echo "<div class='ms-" . ($depth * 4) . " p-3 mb-2'  style='border-left: 2px solid #ccc;'>";
