...
$orders = $conn->query("SELECT o.order_id, c.model, o.total_amount, u.user_id, o.amount_paid, o.payment_status, o.installment_plan, o.payment_option
                        FROM orders o
...
<div class="container my-5">
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <h3 class="mb-0 text-center py-3">Installments List</h3>
                ...
                <table class="table table-bordered table-hover align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($row['payment_option'] === 'installment' && $installments_left > 0): ?>
                                <a href="pay_installment.php?order_id=<?= $row['order_id'] ?>"
                                    class="btn btn-sm">Pay</a>
                                <?php else: ?>
                                <a href="order_confirmation.php?order_id=<?= $row['order_id'] ?>"
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="8">No installemnts found.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
