...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->close();
    header("Location: add_treatment.php?patient_id=$patient_id&success=1");
    exit;
}
...
?>
<div class="container rounded border shadow mt-5 p-4">
    <h3 class="mb-4 text-center">Add Treatment for <?= htmlspecialchars($patient['name']) ?></h3>
