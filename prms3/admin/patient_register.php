...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO patients (name, email, age, disease, password, status) 
        VALUES (?, ?, ?, ?, ?, 'accepted')";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssiss", $name, $email, $age, $disease, $hashed_password);

    if ($stmt->execute()) {
        echo "<script>alert('Registration successful!'); window.location.href='manage_patient.php';</script>";
    } else {
