...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="customer_dashboard.php">Art Gallery</a>
            <div>

                <a href="profile.php" class="btn btn-outline-primary text-white">Profile</a>
                <a href="order_history.php" class="btn btn-outline-success text-white">Order History</a>
                <a href="art_list.php" class="btn btn-outline-warning text-white">View Art</a>
                <a href="cart.php" class="btn btn-outline-secondary text-white">Cart</a>
