...
if (!isset($_SESSION['admin_id']) || $_SESSION['admin_role'] !== 'Admin') {
    $_SESSION['error_msg'] = "You must be logged in as a Admin to access this page.";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="dashboard.php">MSGM Clothing Brand</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="add_cloths.php">Add Cloths</a></li>
            ...
            <div class="user-info">
                <span><?php echo ucfirst($admin_role); ?></span>
