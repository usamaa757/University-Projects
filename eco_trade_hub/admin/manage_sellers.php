...
<div class="container mt-3">
    <a href="manage_users.php"><button class="btn btn-primary mb-2">Back to User</button></a>
                ...
                <?php while ($row = $result->fetch_assoc()) : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- <a href="delete_user.php?seller_id=<?php echo $row['seller_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a> -->
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
