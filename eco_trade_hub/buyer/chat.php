...
$sql = "SELECT messages.*, 
        ...
        WHERE messages.buyer_id = ? AND messages.seller_id = ?
        ORDER BY messages.timestamp ASC";
$stmt = $conn->prepare($sql);
$stmt->bind_param("ii", $buyer_id, $seller_id);
$stmt->execute();
$result = $stmt->get_result();
$seller_name = $result->num_rows > 0 ? $result->fetch_assoc()['seller_name'] : 'Seller';
?>
...
<div class="container mt-3">
        ...
        <div class="chat-container">
            <h3 class="text-center heading-bg bg-dark text-white p-2"><?php echo htmlspecialchars($seller_name); ?></h3>
            ...
            <div class="mb-2">
                ...
                <div id="messageArea">
                    <?php while ($row = $result->fetch_assoc()) : ?>
                        <div class="message-bubble <?php echo $row['sender_type'] == 'buyer' ? 'message-sent' : 'message-received'; ?>">
            ...
            <form id="messageForm">
                <div class="input-group">
                    ...
                    <input type="hidden" id="sender_type" value="buyer">
    ...
    <script>
        document.getElementById('messageForm').addEventListener('submit', function(event) {
            ...
            xhr.send('message=' + encodeURIComponent(message) + '&buyer_id=' + encodeURIComponent(buyer_id) + '&seller_id=' + encodeURIComponent(seller_id) + '&sender_type=' + encodeURIComponent(sender_type));
        });
    </script>
</body>
