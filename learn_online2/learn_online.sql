...
(5, 'Usama', 'usama@gmail.com', '$2y$10$Dv6oYoywQIG4s3joLOsn2./vwPtTE/rLJ/uITQAoZeAUjGZRD.Dhu'),
(6, 'Administrator', 'admin@gmail.com', '$2y$10$LQoEYoOPkrYJoKm1m4EkHuQ/ygdVPhya7XbzjUcD6B.hlTHa5GkMa'),
(7, 'Zakir', 'admin1@gmail.com', '$2y$10$PUNXFF.x3/z5iFYA9xqbI.MtE2XR//RtvFXyHMCfd2quH7UQOLJ76');
...
(1, 1, 'upload assignment updated', '2024-07-05', '2024-07-06', '2024-07-05 13:24:01');
...
(5, 'Lecture 1', 'MP4 720p Aise na Mujhe Tum Dekho Love Song Korean Mix.mp4', '44249049', 'video/mp4', 'mp4', 1, '2024-07-06', '2024-07-06'),
(8, 'Lecture 1', 'Pyar Tera Bachya Warga cute Love Story WATCH NOW.mp4', '36286830', 'video/mp4', 'mp4', 2, '2024-07-06', '2024-07-06');
...
(5, 1, 1, 1, 'updated', '2024-07-06 03:39:47', 10, 'Submitted');
...
(4, 1, 2, '2024-07-05 20:01:47', 1, 'submitted');
...
--
ALTER TABLE `student_quiz`
  MODIFY `student_quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `student_quiz_answers`
--
ALTER TABLE `student_quiz_answers`
  MODIFY `student_answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
