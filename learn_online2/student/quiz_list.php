...
if (isset($_SESSION['student_id'])) {
    ...
    // Fetch submitted quizzes with course names
    $sql = "SELECT c.course_name, q.start_date, q.end_date, sq.marks, sq.status
            FROM courses c
            INNER JOIN quizzes q ON c.course_id = q.course_id
            LEFT JOIN student_quiz sq ON q.quiz_id = sq.quiz_id AND sq.student_id = ?
