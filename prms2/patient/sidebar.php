...
<body>
    ...
    <div class="sidebar d-none d-md-block">
        ...
        <a href="appointments.php"><i class="bi bi-calendar-date me-2 text-info"></i> Appointments</a>
        <a href="book_appointment.php"><i class="bi bi-calendar-plus me-2 text-info"></i> Book Appointment</a>
