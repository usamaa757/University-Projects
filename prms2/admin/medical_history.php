...
if (isset($_GET['patient_id'])) {
    ...
    $stmt = $conn->prepare("SELECT t.treatment_id, t.treatment_date, t.suggested_treatment, p.disease 
        FROM treatment t
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="card rounded-3 border shadow p-3">
                ...
                <a href="upload_reports.php?patient_id=<?= htmlspecialchars($all_treatments[0]['patient_id']); ?>&treatment_id=<?= htmlspecialchars($all_treatments[0]['treatment_id']); ?>"
                ...
                <div class="row g-4 mb-4 border-bottom pb-3">
                    <!-- Treatment Info -->
                        <div class="border rounded p-3 h-100 bg-light">
                            ...
                            <p class="mb-1"><strong>Suggested Treatment:</strong> <?= htmlspecialchars($treatment['suggested_treatment']); ?>
